...
class FlacEncoder extends mediabunny_1.CustomAudioEncoder {
    constructor() {
        super(...arguments);
        this.worker = null;
    ...
    emitPackets(packets) {
        ...
        for (const p of packets) {
            ...
            const packet = new mediabunny_1.EncodedPacket(data, 'key', this.nextTimestampInSamples / this.config.sampleRate, p.samples / this.config.sampleRate);
...
const registerFlacEncoder = () => {
    (0, mediabunny_1.registerEncoder)(FlacEncoder);
};
exports.registerFlacEncoder = registerFlacEncoder;
function assert(x) {
    if (!x) {
